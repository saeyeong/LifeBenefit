...
class BlankFragment1 : Fragment() {
 ...
 /*   var textTitleView: TextView? = null
  ...
  //  lateinit var layoutView: View //데이터 바인딩으로 하십셔~~
    ...
    fun init(){
        ...
        arguments?.let {
         ...
         /*   textTitleView = layoutView.findViewById(R.id.text_title) //이런 코드 노노..
            textContentsView = layoutView.findViewById(R.id.text_contents) // 노노노노노!!!!!!!!!!!!!!!!*/
